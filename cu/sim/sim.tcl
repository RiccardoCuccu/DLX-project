...
# FSM CU
#add wave -divider {CU - ALU} -position insertpoint \
#sim:/tb_dlx/U1/CU_I/aluOpcode_tmp \
#sim:/tb_dlx/U1/CU_I/aluOpcode \
#sim:/tb_dlx/U1/CU_I/ALU_OPCODE
#
#add wave -divider {CU - CONTROL WORDS} -position insertpoint -radix hex \
#sim:/tb_dlx/U1/CU_I/cw_tmp \
#sim:/tb_dlx/U1/CU_I/cw
#
#add wave -divider {CU - STATES} -position insertpoint  \
#sim:/tb_dlx/U1/CU_I/NEXT_STATE \
#sim:/tb_dlx/U1/CU_I/CURRENT_STATE
...
add wave -divider {CU - CONTROL WORDS} -position insertpoint -radix hex \
sim:/tb_dlx/U1/CU_I/cw \
sim:/tb_dlx/U1/CU_I/ICount \
sim:/tb_dlx/U1/CU_I/uPC \
sim:/tb_dlx/U1/CU_I/OpCode_Reloc
